...
public class AuthenticFilter extends OncePerRequestFilter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AuthenticFilter.class);

    private final AuthenticationService autenticacaoService;

    private final GerenciadorTokenJwt jwtTokenManager;

    public AuthenticFilter(AuthenticationService autenticacaoService, GerenciadorTokenJwt jwtTokenManager) {
